        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="form-row">
                            <div class="col-md-12 text-end">
                                <div class="col-md-12 text-end"><a href="{{route('admin_faqcontent-create')}}" class="btn btn-success"><i class="align-middle" data-feather="plus"></i>{{__('Add')}}</a></div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <table id="faqcontent" class="table table-striped table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th>{{__('Id')}}</th>
                                    <th>{{__('Questions')}}</th>
...
$(document).ready(function() {
    ...
    var page = $("#faqcontent").DataTable({
        ...
        "ajax" : {
            url : "{{ route('admin_faqcontent-datatable') }}",
            type : "POST",
            data : function(d) {
                d._token = "{{ csrf_token() }}"
    ...
    $(document).on('click', '.delete', function() {
        ...
        swal({
            title: "",
            text: "{{__('Are you sure? Delete this faqcontent!')}}",
            type: "warning",
