    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="@if(isset($record->id)){{ route('admin_faqcontent-update', array('id' => Crypt::encrypt($record->id))) }}@else{{route('admin_faqcontent-store')}}@endif" id="faqcontent-form" enctype="multipart/form-data" data-parsley-validate="">
                            ...
                            <a href="{{route('admin_faqcontent')}}" class="btn btn-danger">{{__('Cancel')}}</a>
                        </form>
                    </div>
                </div>
            </div>
